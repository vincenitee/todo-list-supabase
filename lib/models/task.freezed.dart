...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,title,isDone,createdAt);

@override
String toString() {
  return 'Task(id: $id, userId: $userId, title: $title, isDone: $isDone, createdAt: $createdAt)';
}
